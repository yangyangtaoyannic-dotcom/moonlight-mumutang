...
public class PcView extends Activity implements AdapterFragmentCallbacks {
    ...
    private void initializeViews() {
        ...
        if(!TextUtils.isEmpty(pref.screenLabel)){
            if (pref.screenLabel.equals("Moonlight (Debug)") || pref.screenLabel.equals("Moonlight (Root Debug)")) {
                String appLabel = getString(R.string.app_label);
                tx_label.setText(appLabel);
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putString("change_screen_label_key", appLabel)
                        .apply();
            }
            else {
